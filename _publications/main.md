...
### 2026:
  ...
  [24]. Mengyuan Fan, Bokai Huang, Jiaming Pan, Xiaokun Yuan, **Peizhuang Cong**, Zhewen Tan, Tong Yang. [RPFQ-ViT: Rotated Phase-Frame Quantization for Extremely Low-Bit Weights in Vision Transformers](). The Fortieth Annual Conference on Neural Information Processing Systems (NeurIPS) 2026.
...
## Patents:
  [3]. 杨仝, 王飞宇, **丛培壮**. 模型量化感知训练方法、装置、设备及存储介质, 已受理.
